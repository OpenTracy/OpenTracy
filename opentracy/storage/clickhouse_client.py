"""ClickHouse read client for opentracy analytics.
...
Environment variables (shared with the Go engine):
    ...
    LUNAR_CH_DATABASE     - Database name (default: opentracy)
...
def _is_enabled() -> bool:
    return env("CH_ENABLED", "").lower() in ("true", "1")
...
def _create_client():
    ...
    return clickhouse_connect.get_client(
        ...
        port=int(env("CH_HTTP_PORT", "8123")),
        database=env("CH_DATABASE", "opentracy"),
