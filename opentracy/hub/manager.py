"""
OpenTracy Hub Manager - Download and manage artifacts.
...
def _get_data_home() -> Path:
    ...
    if sys.platform == "win32":
        ...
        return base / "opentracy"
    elif sys.platform == "darwin":
        return Path.home() / "Library" / "Application Support" / "opentracy"
    else:
        # Linux/Unix - follow XDG spec
        xdg_data = os.environ.get("XDG_DATA_HOME", Path.home() / ".local" / "share")
        return Path(xdg_data) / "opentracy"
...
class Hub:
    """
    OpenTracy Hub - manages artifact downloads.
    ...
    def __init__(
        ...
        self.data_home = Path(data_home) if data_home else OPENTRACY_DATA_HOME
    ...
    def _load_index(self) -> PackageIndex:
        ...
        # Try remote first
        try:
            req = Request(self.index_url, headers={"User-Agent": "opentracy"})
    ...
    def _download_file(
        ...
        req = Request(url, headers={"User-Agent": "opentracy"})
...
def download(
    ...
    Example:
        ...
        Downloading weights-mmlu-v1 (1.0.0)...
          ...
          [==============================] 100.0%
          Extracting...
        ✓ Installed weights-mmlu-v1 to ~/.local/share/opentracy/weights-mmlu-v1
    """
...
def list_packages(
    ...
    Example:
        >>> import opentracy
        >>> for pkg in opentracy.list_packages():
