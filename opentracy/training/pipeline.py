...
def train_clusters(
    ...
    Example:
        >>> from opentracy.training import train_clusters
        >>> from opentracy import PromptDataset
        >>>
...
def profile_models(
    ...
    Example:
        >>> from opentracy.training import profile_models
        >>> from opentracy import LLMClient
        >>>
...
def export_weights(
    ...
    Example:
        >>> from opentracy.training import export_weights
        >>>
        >>> export_weights(
        ...     assigner, profiles,
...
def full_training_pipeline(
    ...
    Example:
        >>> from opentracy.training import full_training_pipeline, TrainingConfig
        >>> from opentracy import PromptDataset, LLMClient
        >>>
        >>> # Load data
...
def quick_train(
    ...
    Example:
        >>> from opentracy.training import quick_train
        >>>
