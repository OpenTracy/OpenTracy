/**
 * Harness page — browse, test, and run agents.
 */
...
function OutputSchemaViewer({ fields }: { fields: Record<string, { type: string; description?: string }> }) {
...
export default function HarnessPage() {
  ...
  return (
    <div>
      <PageHeader title="Harness Agents" />
