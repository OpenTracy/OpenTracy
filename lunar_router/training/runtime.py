...
class TrainingManager:
    ...
    def __init__(
        ...
        *,
        ...
        engine_url: str = "http://lunar-engine:8080",
...
def get_training_manager() -> TrainingManager:
    ...
    if _instance is None:
        _instance = TrainingManager(
            weights_path=os.getenv("LUNAR_WEIGHTS_PATH", "/app/weights"),
            engine_url=os.getenv("LUNAR_ENGINE_URL", "http://lunar-engine:8080"),
        )
    return _instance
